...
namespace Hoza_Ariana_Romina_Lab2.Models
{
    public class BookCategoriesPageModel:PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Hoza_Ariana_Romina_Lab2Context context, Book book)
        {
        ...
        public void UpdateBookCategories(Hoza_Ariana_Romina_Lab2Context context,
